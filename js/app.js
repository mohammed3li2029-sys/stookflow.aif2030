    ...
    <div class="modal modal-xl" style="padding:0; overflow:auto; background:#fff; color:#1a1a1a; border-radius:0; width:95%; max-width:210mm; min-height:auto; height:auto; margin:10px auto; position:relative; box-shadow:0 0 50px rgba(0,0,0,0.5); transform-origin:top center;">
      ...
      <div id="printableQuote" style="padding:30px 30px 140px; font-family:'Tajawal','Inter',sans-serif; color:#1a1a1a; direction:${dir}; text-align:${al}; background:#fff; position:relative; min-height:297mm;">
        ...
        <div style="position:absolute; bottom:30px; left:30px; right:30px; border-top:2px solid #e0e0e0; padding-top:12px; display:flex; justify-content:space-between; align-items:center; font-size:10px; color:#666;">
              ...
              <div style="display:flex; align-items:center; gap:4px;"><svg viewBox="0 0 24 24" width="13" height="13" style="flex-shrink:0;"><circle cx="12" cy="12" r="10" fill="#1a237e"/><path d="M8 7h8c1.1 0 1.5.5 1.5 1v8c0 .5-.4 1-1.5 1H8c-1.1 0-1.5-.5-1.5-1V8c0-.5.4-1 1.5-1z" fill="none" stroke="#fff" stroke-width="1.5" stroke-linejoin="round"/><path d="M10.5 8.5h3" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/><path d="M10.5 15.5h3" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/></svg><span style="direction:ltr; unicode-bidi:embed;">0144290444</span></div>
              <div style="display:flex; align-items:center; gap:4px;"><svg viewBox="0 0 24 24" width="13" height="13" style="flex-shrink:0;"><circle cx="12" cy="12" r="10" fill="#1a237e"/><rect x="7" y="7.5" width="10" height="9" rx="1.5" fill="none" stroke="#fff" stroke-width="1.5" stroke-linejoin="round"/><path d="M7 7.5l5 4.5 5-4.5" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg><span style="direction:ltr; unicode-bidi:embed;">info@abuduhair.com.sa</span></div>
              <div style="display:flex; align-items:center; gap:4px;"><svg viewBox="0 0 24 24" width="13" height="13" style="flex-shrink:0;"><circle cx="12" cy="12" r="10" fill="#1a237e"/><circle cx="12" cy="12" r="5" fill="none" stroke="#fff" stroke-width="1.5"/><path d="M12 7c-2 2.5-2 7.5 0 10" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/><path d="M7 12h10" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/></svg><span style="direction:ltr; unicode-bidi:embed;">www.abuduhair.com.sa</span></div>
            </div>
